...
<main id="privacyPolicy">
    <h1 class="pageHeadline">Datenschutz</h1>
    ...
    <div class="contentBg">
        <div class="content">
            ...
            <div class="table">
                <ul>
                    <li>HONNEF Immobilien Gotha GbR</li>
                    <li>Peter Honnef & Dirk Honnef</li>
                    <li>Arnoldiplatz 5</li>
                    <li>99867 Gotha</li>
                </ul>
                <ul>
                    <li>HONNEF Immobilien GmbH</li>
                    <li>Arnoldiplatz 5</li>
                    <li>99867 Gotha</li>
                    <li>eingetragen Amtsgericht Jena HRB 109315</li>
                </ul>
            </div>
            <p>Telefon: 03621.300000<br />
                E-Mail: <a href="mailto:info@honnef-immobilien.de">info@honnef-immobilien.de</a></p>
    ...
    <div class="content">
        ...
        <p>Weitere Informationen über Datenschutz bei YouTube finden Sie in deren Datenschutzerklärung unter: <a href="https://policies.google.com/privacy?hl=de&amp;gl=de" rel="noopener" target="_blank">https://policies.google.com/privacy?hl=de&amp;gl=de</a>.</p>
        <h3>
            Google Web Fonts</h3>
